...
def launch_latest_edge_server( base_dir ):
    ...
    """
    target_dir = find_latest_version( base_dir )

    launch_faircom_server( target_dir )


def launch_faircom_server( target_dir ):
...
def find_latest_version( base_dir ) -> Path | None:
...
def is_process_running( process_name: str ) -> bool:
    ...
    This process has no way of knowing if the running server was launched from server_directory.
...
if __name__ == "__main__":
    ...
    installation_directory = "/FairCom/"
